...
1. **System GMM:** Identification of structural parameters and baseline elasticities.
2. **Hierarchical BVAR:** Modeling of adjustment dynamics and medium-term trajectories.
3. **Neural IRF:** Application of Deep Learning (ReLU activation) to capture non-linearities and fiscal asymmetries.
